    ...
    sepet.forEach(function (urun) {
      ...
      html += '' +
        '<div style="display:flex;gap:0.75rem;padding:0.75rem 0;border-bottom:1px solid rgba(255,255,255,0.06);align-items:center;">' +
          '<a href="/urunler/' + urun.slug + '/" style="text-decoration:none; cursor:pointer; flex-shrink:0;">' +
          ...
          '<div style="flex:1;min-width:0;">' +
            '<a href="/urunler/' + urun.slug + '/" style="text-decoration:none; color:inherit; cursor:pointer;">' +
